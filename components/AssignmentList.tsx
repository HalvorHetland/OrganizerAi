    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 h-full flex flex-col">
      <div className="flex items-center justify-between mb-1">
         <div className="flex items-center">
            <ClipboardCheckIcon className="h-8 w-8 text-blue-500 dark:text-blue-400 mr-3" />
            ...
            return (
                <div
                    ...
                    className={`p-4 rounded-lg flex flex-col transition-all duration-300 ${
                        ...
                        : dueSoon 
                        ? 'bg-yellow-100 dark:bg-yellow-800/40 border-l-4 border-yellow-500 dark:border-yellow-400'
                ...
                >
                    <div className="flex items-center justify-between w-full">
                        ...
                        {dueSoon && <BellIcon className="h-5 w-5 text-yellow-600 dark:text-yellow-400 animate-pulse" />}
                    </div>
                    {assignees.length > 0 && (
