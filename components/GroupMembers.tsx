  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 h-full flex flex-col">
      <div className="flex items-center mb-4">
        <UsersIcon className="h-8 w-8 text-green-500 dark:text-green-400 mr-3" />
      ...
      <form onSubmit={handleAddSubmit} className="flex items-center space-x-2 border-t border-gray-200 dark:border-gray-700 pt-4">
        <input
          ...
          className="flex-1 p-2 bg-gray-100 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-900 dark:text-white"
        />
        <button
          type="submit"
          className="p-2 bg-green-600 text-white rounded-full hover:bg-green-700 disabled:bg-green-400 dark:disabled:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
