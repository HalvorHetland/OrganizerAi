...
const colorPalette = [
  ...
  'dark:bg-red-800', 'dark:bg-blue-800', 'dark:bg-green-800', 'dark:bg-yellow-800', 'dark:bg-purple-800', 'dark:bg-pink-800'
];

const textColorPalette = [
    'text-red-800', 'text-blue-800', 'text-green-800', 'text-yellow-800', 'text-purple-800', 'text-pink-800',
    'dark:text-red-100', 'dark:text-blue-100', 'dark:text-green-100', 'dark:text-yellow-100', 'dark:text-purple-100', 'dark:text-pink-100'
];
